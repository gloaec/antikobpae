class GroupFolderPermissionsController < ApplicationController
  before_filter :require_admin

  def update_multiple
    permissions = GroupFolderPermission.update(params[:permissions].keys, params[:permissions].values)
